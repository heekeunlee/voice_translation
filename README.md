# 🌐 PolyVoice Live (초저지연 실시간 음성 번역 & 영어 학습 AI)

> **"초저지연 실시간 타이핑 동시통역"**, **"말버릇/비문 자동 정제(Disfluency Removal)"**, **"전문 용어집(TM)"** 및 **"5대 맞춤 번역 모드"**를 탑재하고, **영어 학습(섀도잉, 어휘 분석, 플래시카드)**에 특화된 차세대 실시간 음성 번역 웹 애플리케이션입니다.
...
* **실시간 타이핑 렌더링:** 말하는 도중 단어 단위로 즉시 번역 텍스트가 타이핑 스트리밍되어 체감 지연 속도를 극소화(100~300ms)했습니다.
